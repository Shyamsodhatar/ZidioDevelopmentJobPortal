        ...
        <form >
          <div className='flex justify-start md:flex-row flex-col md:gap-0 gap-4'>
            ...
            focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 md:w-1/2 w-full">
                <input type="text" name="title" id="title" placeholder="What Postion Are You Looking for ? " className='block flex-1 border-0 *
                bg-transparent py-1.5 pl-8 text-gray-400 placeholder:text-gray-900 focus-within:right-0 sm:text-sm sm:leading-6' onChange={handLeInputChange}
                value={query}/>
            ...
            focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 md:w-1/3 w-full">
                ...
                bg-transparent py-1.5 pl-8 text-gray-400 placeholder:text-gray-900 focus-within:right-0 sm:text-sm sm:leading-6' 
                />
