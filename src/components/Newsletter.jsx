  ...
  return (
    <div>
        <div>
            ...
            <p className='text-primary/75 text-base mb-4'>Ut esse eiumod aute. Sit enim labore dolore. Aute ea Fugiat commondo a foes</p>
            <div className='w-full space-y-4'>
                <input type="email" name="email" id="mail" placeholder='name@gmail.com' className='w-full block py-2 pl-3 border focus:outline-none'/>
