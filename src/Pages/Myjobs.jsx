...
const Myjobs = () => {
    const email="shyambarot27@gmail.com"
    ...
    useEffect(()=>{
        setIsLoading(true)
        fetch(`http://localhost:3000/Myjobs/shyambarot27@gmail.com`)
        .then((res)=>res.json())
        .then((data)=>{
          setJobs(data);
          setIsLoading(false);
  ...
  return <div className='mx-w-screen-2xl container mx-auto xl:px-24 px-4'>
    <div className='my-jobs-container'>
      <h1 className='text-center p-4 '> All My Jobs</h1>
      <div className='search-box p-2 text-center mb-2 '>
        <input 
         onChange={(e)=>setSearchText(e.target.value)} type="text" name="search" id="search" className='py-2 pl-3 border focus:outline-none lg:w-6/12 mb-4 w-full'/>
